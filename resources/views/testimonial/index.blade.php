                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="service_type" id="a6">
                                                    ...
                                                    <option value="Training Service" {{ old('service_type') == 'training_service' ? 'selected' : '' }}>Training Service</option>
                                                    <option value="Project Management Service" {{ old('service_type') == 'project_service' ? 'selected' : '' }}>Project Management Service</option>

                                                    <option value="Customized Solution" {{ old('service_type') == 'customized_solution' ? 'selected' : '' }}>Customized Solution</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
