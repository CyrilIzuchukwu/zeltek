                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            ...
                                            <div class="logo-upload">
                                                <input type="file" name="event_image" id="clientImageInput" accept=".png, .jpg, .jpeg">

                                                <label for="clientImageInput" class="camera-icon">
                                                    <img id="clientImagePreview" src="{{ asset('event_images/' . $data->image) }}" class="client-image">
                                                    <i class="ri-file-image-line"></i>
                                                </label>
                                            </div>
                                            <span class="text-danger">@error('event_image') {{ $message }} @enderror</span>
                                        </div>

                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="a8">Content <span class="text-danger">*</span></label>
                                                <textarea class="form-control" name="content" id="summernote" placeholder="Enter Content" rows="4">{{ old('content', $data->content) }}</textarea>
